return {
  ...
  keys = {
    ...
    { "<leader>E", function() Snacks.explorer.reveal() end, desc = "File Explorer at Current File" },
    -- find
    ...
    { "f*", function() Snacks.picker.grep_word() end, desc = "Visual selection or word", mode = { "n", "x" } },
    -- search
    { 'fr', function() Snacks.picker.registers() end, desc = "Registers" },
